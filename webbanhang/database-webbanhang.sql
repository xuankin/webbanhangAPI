...
INSERT INTO `account` (`id`, `username`, `fullname`, `password`, `role`) VALUES
	(1, 'king', 'nguyenxuankin', '$2y$12$v0A/lZFSPdn05VGquRljU.6ZcC0RXzKLHWvsUqIdvsRIQjCi2/l26', 'user'),
	(2, 'admin', 'admin123', '$2y$12$gN9cvAMfYxrLezgRNs0CmegZoFDAdRB4SGFT61Z7JiLfZmpzYPWxK', 'admin');
